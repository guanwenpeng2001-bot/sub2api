...
func TestIsOpenAIOAuthServableModel(t *testing.T) {
	...
	require.False(t, isOpenAIOAuthServableModel("qwen-image-plus"))
	require.False(t, isOpenAIOAuthServableModel("wanx-v1"))
	require.False(t, isOpenAIOAuthServableModel("wan2.2-t2i-flash"))
